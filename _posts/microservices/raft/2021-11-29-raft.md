...
一个raft模块和其他部分的交互图[https://pdos.csail.mit.edu/6.824/notes/raft_diagram.pdf](https://pdos.csail.mit.edu/6.824/notes/raft_diagram.pdf)，可以帮助你理解raft模块与其他部分是如何交互的。
...
- 提示：指导书[https://pdos.csail.mit.edu/6.824/labs/guidance.html](https://pdos.csail.mit.edu/6.824/labs/guidance.html)里面有一些怎么开发，怎么调试代码的建议。
