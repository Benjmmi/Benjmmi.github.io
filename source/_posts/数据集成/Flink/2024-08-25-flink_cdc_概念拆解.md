...
![image](https://static001.geekbang.org/infoq/e5/e5ffcb17cb56e867c9f6cf7d36a4cd69.png)
其代码实现如下：
...
![image](https://static001.geekbang.org/infoq/60/60521b27755dfd35c7c47b17c2880c21.png)
...
MetaDataApplier 用于将表结构变更应用到外部系统中。在 SchemaRegistry 接受到所有的 Sink 算子处理完 FlushEvent 的通知后，由 SchemaRegistry 负责调用 MetaDataApplier 的 applySchemaChange 方法去应用表结构变更事件。考虑到任务重启的情况，MetaDataApplier 需要支持对一个表结构变更事件幂等处理。
...
- [Flink CDC：基于 Apache Flink 的流式数据集成框架](https://xie.infoq.cn/article/1b9c14d003b57c9fbb277a854)
- [新一代实时数据集成框架 Flink CDC 3.0 —— 核心技术架构解析](https://xie.infoq.cn/article/66726d61bc51dcfcb181919d9)
