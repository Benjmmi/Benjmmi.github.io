...
description: ""
tagline: ""
date: '2024-07-29 13:48:10'
category: flowable
tags: flowable
---
> {{ page.description }}

>>> 来自于 `org.flowable.engine.impl.cfg.ProcessEngineConfigurationImpl`
使用 ChatGPT 理解源码
# 前言
...
（这里可以改进，JOB 每次只生成一条大量浪费CPU资源，可以按照任务提前生成所需要执行的任务）
...
**特殊管理器**
    ...
    1.  `DeploymentProcessDefinitionDeletionManager`
